...
import { Colors, getCurrentLocation, Metrix, NavigationService, Icons } from "../../config";
...
const MapScreen = (props) => {
    ...
    return (
        <View style={styles.container}>
           ...
           <Pressable onPress={() => NavigationService.goBack()} style={styles.backButton}>
             <Icons.AntDesign style={styles.iconStyle} name={'arrowleft'}/> 
            </Pressable>

            <Pressable onPress={navigateToCurrentLocation} style={styles.currentLocationButton}>
