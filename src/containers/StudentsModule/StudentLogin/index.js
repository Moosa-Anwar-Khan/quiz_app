...
import { FacebookSocialButton } from 'react-native-social-buttons/src/buttons/FacebookSocialButton';
...
const StudentLogin = () => {
    ...
    const handleSignUpButton = () => {
        NavigationService.navigate("StudentSignUp");
    }
    ...
    const handleLogin = () => {
        try {
            if (email === "" || password === "") {
                ...
                setEmail("");
                setPassword("");
                dispatch(AppAction.LoginStudent({ userEmail: email, userPassword: password }));
            }
        }
        catch (err) {
            console.log(err);
    ...
    const googleSignin = async () => {
            dispatch(AppAction.GoogleLoginStudent());
    }

    const facebookLogin = () => {
        dispatch(AppAction.FBLoginStudent());
    }
    ...
    return (
        ...
        <View style={styles.myView}>
            ...
            <Image localImage={Images.quizStudentLoginImage} imageStyle={styles.quizHomeIcon}
                resizeMode={"contain"} />

            <CustomText.RegularText style={styles.iconText} text="Student's Account Login" />
